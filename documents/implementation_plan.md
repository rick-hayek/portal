...
| **Phase 1** | 核心系统 | 10 天 | ⬜ 待开始 | 主题 + 布局 + 配置 + 模块加载 |
| **Phase 2** | MVP 最小系统 | 14 天 | ⬜ 待开始 | DB → API → Blog + About + 留言板 |
| **Phase 3** | 内容增强 | 13 天 | ⬜ 待开始 | 搜索 + 认证 + 管理后台基础 |
| **Phase 4** | 展示与管理 | 10 天 | ⬜ 待开始 | 作品集 + 统计 + 管理后台完善 |
| **Phase 5** | 扩展模块 | 12 天 | ⬜ 待开始 | 简历 + 图库 + 友链 + 工具箱 |
...
| **M1** 核心跑通 | 主题 + 布局 + 模块加载 | 13 | ⬜ |
| **M2** MVP 上线 🎯 | Blog + About + 留言板（数据库全链路） | 27 | ⬜ |
| **M3** 内容增强 | 搜索 + 认证 + 管理后台 | 40 | ⬜ |
| **M4** 展示完善 | 作品集 + 统计 + 管理后台完整 | 50 | ⬜ |
| **M5** 全模块 | 简历 + 图库 + 友链 + 工具箱 | 62 | ⬜ |
