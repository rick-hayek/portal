        ...
        <div className="flex w-full flex-col items-center">
            <section className="mx-auto w-full max-w-[1200px] px-8" style={{ padding: '8rem 2rem 5rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.8rem', marginBottom: '3rem' }}>
                    ...
                    <span style={{ fontFamily: 'var(--portal-font-mono)', fontSize: '0.7rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--portal-color-primary)', fontWeight: 500 }}>{t('subtitle')}</span>
                    <h1 style={{ fontSize: '1.6rem', fontWeight: 700, letterSpacing: '-0.03em', color: 'var(--portal-color-text)' }}>{t('title')}</h1>
                </div>
                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
                    ...
                    <div style={{
                        ...
                        <h3 className="mb-6 text-lg font-bold text-[var(--portal-color-text)]">{t('experience')}</h3>
                        <div className="space-y-0">
                            {[
                                { role: t('jobs.senior'), company: 'Tech Corp', period: `2023 — ${t('jobs.present')}` },
