...
import { ArrowLeft, Check, Copy, Shield, Trash2 } from 'lucide-react';
...
export default function JwtDecoderPage() {
  ...
  const getPartStyle = (index: number) => {
    switch (index) {
      ...
      default:
        return 'text-[var(--portal-color-text)]';
    }
  };
    ...
    <div className="mx-auto max-w-5xl space-y-8">
      <header className="space-y-4">
        <div className="flex items-center gap-4">
          ...
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[rgba(249,115,22,0.1)] text-orange-500">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col rounded-2xl border border-[var(--portal-color-border)] bg-[#1e1e1e] shadow-sm overflow-hidden h-fit">
            <div className="flex items-center justify-between border-b border-white/10 px-4 py-3 bg-[#1e1e1e]">
              <h2 className="text-sm font-semibold text-gray-300">{t('header')}</h2>
              <button
          ...
          <div className="flex flex-col rounded-2xl border border-[var(--portal-color-border)] bg-[#1e1e1e] shadow-sm overflow-hidden flex-1">
            <div className="flex items-center justify-between border-b border-white/10 px-4 py-3 bg-[#1e1e1e]">
              <h2 className="text-sm font-semibold text-gray-300">{t('payload')}</h2>
              <button
                onClick={() =>
          ...
          <div className="flex flex-col rounded-2xl border border-[var(--portal-color-border)] bg-[#1e1e1e] shadow-sm overflow-hidden h-fit">
            <div className="flex items-center justify-between border-b border-white/10 px-4 py-3 bg-[#1e1e1e]">
              <h2 className="text-sm font-semibold text-gray-300">{t('signature')}</h2>
              <button
            ...
            <div className="p-4 overflow-auto break-all">
              <pre className="text-sm font-mono text-blue-300">
                <code>{decoded?.signature || 'signature string'}</code>
              </pre>
            </div>
          </div>
        </div>
