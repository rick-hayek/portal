            ...
            <div className="grid grid-cols-1 gap-12 md:grid-cols-[1fr_2.5fr]">
                ...
                <div className="space-y-8">
                    ...
                    <section className="print:hidden space-y-4 rounded-2xl bg-[var(--portal-color-surface)] p-6 border border-[var(--portal-color-border)] shadow-sm">
                        <h2 className="text-xs font-bold uppercase tracking-widest text-[var(--portal-color-text-secondary)]">{t('contact')}</h2>
                    ...
                    {/* Skills */}
                    <section>
                        <h2 className="mb-4 text-xs font-bold uppercase tracking-widest text-[var(--portal-color-text-secondary)]">{t('skills')}</h2>
                ...
                <div className="space-y-12">
                    {/* Summary */}
                    <section>
                        <h2 className="mb-6 text-2xl font-bold text-[var(--portal-color-text)]">{t('profile')}</h2>
                    ...
                    {/* Experience */}
                    <section>
                        <h2 className="mb-8 text-2xl font-bold text-[var(--portal-color-text)]">{t('experience')}</h2>
                        <Timeline
                    ...
                    {/* Education */}
                    <section>
                        <h2 className="mb-8 text-2xl font-bold text-[var(--portal-color-text)]">{t('education')}</h2>
                        <Timeline
