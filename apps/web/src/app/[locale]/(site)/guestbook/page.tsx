...
export default function GuestbookPage() {
  ...
  return (
    <div style={{ padding: '5rem 2rem', maxWidth: 1200, margin: '0 auto', width: '100%' }}>
          ...
          {entries.map((entry) => (
            ...
            >
              <div className="flex items-center" style={{ gap: '.6rem', marginBottom: '.5rem' }}>
                <span
                  className="flex items-center justify-center rounded-full bg-[var(--portal-color-primary)]/10 text-[var(--portal-color-primary)]"
      ...
      {/* Stats Row */}
      <div
        className="flex border-t border-[var(--portal-color-border-soft)]"
