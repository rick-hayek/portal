        ...
        <div className="flex w-full flex-col">
                ...
                <div className="mx-auto w-full max-w-[1200px]" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
                    ...
                    <div>
                        ...
                        <h1 style={{ fontSize: 'clamp(2.8rem, 5vw, 4.5rem)', fontWeight: 800, lineHeight: 1.05, letterSpacing: '-0.04em', marginBottom: '1.5rem' }}>
                            Building the<br />
                            <span style={{ color: 'var(--portal-color-primary, #6b8ec9)' }}>Modern Web</span>
                        </h1>
                        ...
                        <p style={{ fontSize: '1.05rem', lineHeight: 1.75, maxWidth: '440px', marginBottom: '2.5rem', borderLeft: '2px solid rgba(107, 142, 201, 0.25)', paddingLeft: '1.2rem', color: 'var(--portal-color-text-secondary, #4b5563)' }}>
                            Focused on TypeScript & Next.js ecosystem. I write clean code,
                            share learnings, and build tools that developers love.
                        </p>
            ...
            <section style={{ padding: '5rem 2rem', maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.8rem', marginBottom: '2.5rem' }}>
                    ...
                    <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: '0.7rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--portal-color-primary, #6b8ec9)', fontWeight: 500 }}>Latest Posts</span>
                    <h2 style={{ fontSize: '1.6rem', fontWeight: 700, letterSpacing: '-0.03em', color: 'var(--portal-color-text, #111827)' }}>Blog</h2>
                </div>
                ...
                <section style={{ padding: '5rem 2rem', maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
                    <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: '2.5rem' }}>
                        <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.8rem' }}>
                            <span style={{ width: '28px', height: '2px', background: 'var(--portal-color-primary, #6b8ec9)', flexShrink: 0 }}></span>
                            <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: '0.7rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--portal-color-primary, #6b8ec9)', fontWeight: 500 }}>Selected Work</span>
                            <h2 style={{ fontSize: '1.6rem', fontWeight: 700, letterSpacing: '-0.03em', color: 'var(--portal-color-text, #111827)' }}>Projects</h2>
                        </div>
            ...
            <section style={{ padding: '5rem 2rem', maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.8rem', marginBottom: '2.5rem' }}>
                    <span style={{ width: '28px', height: '2px', background: 'var(--portal-color-primary, #6b8ec9)', flexShrink: 0 }}></span>
                    <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: '0.7rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--portal-color-primary, #6b8ec9)', fontWeight: 500 }}>Community</span>
                    <h2 style={{ fontSize: '1.6rem', fontWeight: 700, letterSpacing: '-0.03em', color: 'var(--portal-color-text, #111827)' }}>Guestbook</h2>
                </div>
