        ...
        return (
            <div className="mx-auto max-w-5xl py-12 px-4 sm:px-6 lg:px-8">
                <div className="mb-8 space-y-4 text-center">
                    <h1 className="text-4xl font-black text-[var(--portal-color-text)] tracking-tight">Gallery</h1>
                    <p className="text-[var(--portal-color-text-secondary)]">Loading beautiful moments...</p>
                </div>
    ...
    if (!mediaItems || mediaItems.length === 0) {
        return (
            <div className="mx-auto max-w-5xl py-12 px-4 sm:px-6 lg:px-8 text-center">
                <h1 className="text-4xl font-black text-[var(--portal-color-text)] tracking-tight">Gallery</h1>
                <p className="mt-8 text-[var(--portal-color-text-secondary)]">No photos found.</p>
            </div>
        );
    }
    ...
    return (
        <div className="mx-auto max-w-5xl py-12 px-4 sm:px-6 lg:px-8">
            <div className="mb-12 text-center">
                <h1 className="text-4xl font-black text-[var(--portal-color-text)] tracking-tight">Gallery</h1>
                <p className="mt-4 text-lg text-[var(--portal-color-text-secondary)]">A collection of moments captured in time.</p>
            </div>
